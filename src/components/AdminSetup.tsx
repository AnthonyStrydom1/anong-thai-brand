    ...
    <div className="max-w-2xl mx-auto p-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Set up your admin user and access the admin dashboard
          </CardDescription>
        </CardHeader>
              ...
              {!user && (
                <div className="p-4 border rounded-lg bg-gray-50">
                  <p className="text-sm text-gray-700">
                    You can create a new admin account above, or sign in with an existing account to assign admin privileges.
                  </p>
                </div>
              )}
            </div>
