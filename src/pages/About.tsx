    ...
    th: {
      ...
      story: {
        ...
        content: [
          ...
          "หลังจากย้ายไปอยู่ในสหรัฐอเมริกาในช่วงปี 1990 อนงค์รู้สึกผิดหวังกับวัตถุดิบอาหารไทยที่มีในตลาดท้องถิ่น รสชาติไม่เหมือนกับที่คุ้นเคย กลิ่นหอมไม่เหมือนของแท้ เธอจึงเริ่มทำน้ำพริกและซอสของเธอเองโดยใช้วิธีการแบบดั้��เดิมและนำเข้าวัตถุดิบจากประเทศไทย",
